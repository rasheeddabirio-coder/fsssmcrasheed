...
const langData = {
    ...
    ar: {
        ...
        homeText:
            "مركز روحي ومجتمعي مخصص للعبادة والتعليم وخدمة الإنسانية.",
        aboutTitle: "عن المسجد",
        aboutText:
            "يخدم المسجد المجتمع من خلال التعليم الإسلامي والتنمية الروحية.",
        prayerTitle: "مواقيت الصلاة المباشرة",
        eventsTitle: "الفعاليات القادمة",
        donateTitle: "دعم المسجد",
        donateText:
            "تبرعاتكم تساعد في صيانة المسجد ودعم البرامج المجتمعية.",
...
function getPrayerTimes() {
    ...
    fetch(url)
        ...
        .catch(() => {
            alert("Unable to load prayer times. Please check your internet connection.");
        });
}
